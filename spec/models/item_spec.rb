...
describe Item, type: :model do
  ...
  describe "class methods" do
    ...
    it ".most_purchased" do
      ...
      ItemOrder.create!(item: tire, order: order1, price: tire.price, quantity: 5)
      ItemOrder.create!(item: pull_toy, order: order2, price: pull_toy.price, quantity: 4)
      ItemOrder.create!(item: dog_bone, order: order1, price: dog_bone.price, quantity: 3)
      ItemOrder.create!(item: tire, order: order2, price: tire.price, quantity: 5)
      ItemOrder.create!(item: dog_ball, order: order2, price: dog_ball.price, quantity: 2)
      ItemOrder.create!(item: dog_bowl, order: order2, price: dog_bowl.price, quantity: 1)
