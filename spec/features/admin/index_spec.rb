...
RSpec.describe "As an Admin,", type: :feature do 
  describe "when I visit the admin dashboard '/admin'" do 
    ...
    it "then I see a button to ship package orders that, when clicked, changes status to shipped and user can no longer cancel order." do 
      visit admin_dashboard_path
      ...
      within "#order-#{@order2.id}" do
        ...
        expect(page).to have_link("Ship this Order")
      ...
      within "#order-#{@order2.id}" do
        ...
        expect(page).to_not have_link("Ship this Order")
      end
