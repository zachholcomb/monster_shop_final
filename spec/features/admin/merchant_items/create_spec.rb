...
RSpec.describe 'As an admin when I visit a merchants items page' do
  before(:each) do
  ...
  it "I see a link to add a new item" do
   ...
   it "I can click a link to add a new item and I am taken to a form to add new item" do
    visit "/admin/merchants/#{@meg.id}/items"
    click_link('Add New Item')
    expect(page).to have_current_path("/admin/merchants/#{@meg.id}/items/new")
